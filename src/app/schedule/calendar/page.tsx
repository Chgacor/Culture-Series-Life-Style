...
export default function MonthlyCalendarPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-20">
      ...
      {/* HEADER */}
      <header className="flex justify-between items-center bg-white dark:bg-[#121212] p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
        <div>
        ...
        <button onClick={() => { setNewTask({...newTask, startDate: todayStr}); setShowAddForm(true); }} className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl font-bold flex items-center gap-2 transition-all shadow-lg shadow-indigo-500/20">
